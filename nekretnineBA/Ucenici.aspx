<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ucenici.aspx.cs" Inherits="WebApplication1.Kontakt" %>
...
<body>
    ...
    <br />
    <br />
    <h1 class="section-title">Ucenici na projektu</h1>
    <br />
    <br />
    <center>
        <asp:GridView ID="GridView1" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" 
                RowStyle-CssClass="rows"  runat="server" AutoGenerateColumns="False" DataKeyNames="UcenikID" DataSourceID="SqlDataSource1" Width="244px">
            <Columns>
                <asp:BoundField DataField="UcenikID" HeaderText="UcenikID" InsertVisible="False" ReadOnly="True" SortExpression="UcenikID" />
                <asp:BoundField DataField="Ime" HeaderText="Ime" SortExpression="Ime" />
                <asp:BoundField DataField="Prezime" HeaderText="Prezime" SortExpression="Prezime" />
                <asp:BoundField DataField="BrojUDnevniku" HeaderText="BrojUDnevniku" SortExpression="BrojUDnevniku" />
            </Columns>
            <HeaderStyle CssClass="header" />
            <PagerStyle CssClass="pager" />
            <RowStyle CssClass="rows" />
        </asp:GridView>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:nekretnineBAConnectionString %>" SelectCommand="SELECT * FROM [Grupa5]"></asp:SqlDataSource>
   </center>
        <br />
    <br />
    <br />
